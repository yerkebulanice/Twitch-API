...
//  Endterm App
//
//  Created by Еркебулан on 25.05.2021.
//
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        let config = TWConfig(redirectUri: "http://localhost", scopes: [TWConfig.Scope.openid])
        // Initialize the Twitch object with client ID and configuration
        Twitch.initialize(clientId: "wbmytr93xzw8zbg0p1izqyzzc5mbiz", config: config)
        return true
    }
